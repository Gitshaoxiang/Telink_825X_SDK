...
typedef enum
{
	...
	GenericAttribute_ServiceChanged_CD_H_1,	//UUID: 2803, 	VALUE:  			Prop: Indicate
	GenericAttribute_ServiceChanged_DP_H_1,   //UUID:	2A05,	VALUE: service change
	GenericAttribute_ServiceChanged_CCB_H_1,	//UUID: 2902,	VALUE: serviceChangeCCC

	GenericAttribute_ServiceChanged_CD_H_2,	//UUID: 2803, 	VALUE:  			Prop: Indicate
	GenericAttribute_ServiceChanged_DP_H_2,   //UUID:	2A05,	VALUE: service change
	GenericAttribute_ServiceChanged_CCB_H_2,	//UUID: 2902,	VALUE: serviceChangeCCC
	
	GenericAttribute_ServiceChanged_CD_H_3,	//UUID: 2803, 	VALUE:  			Prop: Indicate
	GenericAttribute_ServiceChanged_DP_H_3,   //UUID:	2A05,	VALUE: service change
	GenericAttribute_ServiceChanged_CCB_H_3,	//UUID: 2902,	VALUE: serviceChangeCCC
